            ...
            <form id="form">
              ...
              <div class="mb-3">
                ...
                <div id="name" class="form-text">
                  Solo puedes crear un nuevo producto, si quieres agregar al inventario debes ir a la sección de
                  Almacen.
                </div>
              </div>
              <div class="mb-3">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <div class="form-text">
                Si eliminas un producto, automaticamente eliminaras los registro de su producción, pero si
