...
<body>
  <header>
  <div class="image">
            <img src="img/logosaas.svg">
        </div>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <h1 class="navbar-brand mb-0" href="#">CONTROL DE INVENTARIO</h1>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            ?>
              ...
              <li class="nav-item">
                <a class="nav-link" href="productions.php">Almacen</a>
              </li>
            <?php
            }
            ?>
  ...
  <main>
    <section class="container-fluid">
      <h2 class="h1 text-center text-uppercase mt-3 mb-5">Almacen de productos</h2>
      <div class="mb-2">
        ...
        <button id="graphicModalButton" type="button" class="mb-2 btn btn-primary">
          Generar gráfica de los productos más pedidos en Almacen
        </button>
      </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title fs-5">Formulario para el almacenamiento</h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form id="form">
              <div class="mb-3">
                <label for="products" class="form-label">Selecciona el producto que desesas almacenar</label>
                <select id="products" class="form-select"></select>
                <div id="products" class="form-text">
                  Si el producto que deseas almacenar no esta aquí, debes ir a la sección de productos y crearlo.
                </div>
              </div>
              <div class="mb-3">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <button type="button" class="w-100 btn btn-primary" id="updateButton">Enviar a Tienda</button>
            </div>
            <div class="mb-3">
              <button type="button" class="w-100 btn btn-danger" id="deleteButton">Eliminar de almacen</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="graphicModal" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title fs-5">Grafico de barra de los productos más pedidos en Almacen</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
